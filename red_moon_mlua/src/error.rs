...
impl From<Error> for red_moon::errors::RuntimeError {
    fn from(value: Error) -> Self {
        use red_moon::errors::RuntimeErrorData;

        RuntimeErrorData::NativeError(value.into()).into()
    }
}

impl From<red_moon::errors::RuntimeError> for Error {
    fn from(value: red_moon::errors::RuntimeError) -> Self {
